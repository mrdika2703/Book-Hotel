                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi_fasilitas" id="deskripsi_fasilitas_{{ $hotel->id }}" class="form-control" rows="3"
                            placeholder="Masukkan Deskripsi Kamar" required>{{ old('deskripsi_fasilitas', $hotel->deskripsi_fasilitas) }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="foto_fasilitas1"
                            ...
                            @if ($hotel->foto1)
                            <div class="mt-3">
                                <img src="{{ asset('storage/' . $hotel->foto1) }}" class="img-thumbnail" alt="Foto Kamar 1" style="max-width: 200px;">
                            </div>
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="foto_fasilitas2"
                            ...
                            @if ($hotel->foto2)
                            <div class="mt-3">
                                <img src="{{ asset('storage/' . $hotel->foto2) }}" class="img-thumbnail" alt="Foto Kamar 1" style="max-width: 200px;">
                            </div>
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="foto_fasilitas3"
                            ...
                            @if ($hotel->foto3)
                            <div class="mt-3">
                                <img src="{{ asset('storage/' . $hotel->foto3) }}" class="img-thumbnail" alt="Foto Kamar 1" style="max-width: 200px;">
                            </div>
                        @endif
